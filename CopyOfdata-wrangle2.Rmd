...
ggplot(top_bottom_2019_happiness, mapping=aes(x=country, y=values, fill=category))+
  geom_col(position="dodge", color="black", size=.25)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 270, hjust = 0))+
  scale_x_discrete(labels = c("Finland (1)", "Denmark (2)", "Norway (3)", "Iceland (4)", "Netherlands (5)", "Rwanda (152)", "Tanzania (153)", "Afghanistan (154)", "Central African\n Republic (155)", "South Sudan (156)"))+
  scale_fill_discrete(labels = c("Social support", "Freedom to make\n life choices", "Generosity", "Healthy life expectancy\n at birth", "Perceptions of \n corruption"))+
  labs(x="Country (with rank)")
